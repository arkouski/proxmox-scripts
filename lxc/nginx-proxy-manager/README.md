...
***Note:*** _Testing if this will create ubuntu container_

```bash
curl -sL https://raw.githubusercontent.com/arkouski/proxmox-scripts/new-branch/lxc/nginx-proxy-manager/create.sh | bash -s
```
...
```bash
curl -sL https://raw.githubusercontent.com/arkouski/proxmox-scripts/new-branch/lxc/nginx-proxy-manager/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://raw.githubusercontent.com/arkouski/proxmox-scripts/new-branch/lxc/nginx-proxy-manager/setup.sh | sh
```
